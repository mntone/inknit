...
#define MSG_CX_GREATER_THAN_MAX_VALUE "ERROR: cx > 2^12-1"
#define MSG_CY_GREATER_THAN_MAX_VALUE "ERROR: cy > 2^12-1"

#define MSG_DX_GREATER_THAN_MAX_VALUE "ERROR: dx > 2^12-1"
#define MSG_DY_GREATER_THAN_MAX_VALUE "ERROR: dy > 2^12-1"

#define MSG_RADIUS_GREATER_THAN_MAX_VALUE "ERROR: radius > 2^12-1"

#define MSG_SX_GREATER_THAN_MAX_VALUE "ERROR: sx > 2^12-1"
#define MSG_SY_GREATER_THAN_MAX_VALUE "ERROR: sx > 2^12-1"

#define MSG_X_LESS_THAN_ZERO          "ERROR: x < 0"
#define MSG_X_GREATER_THAN_MAX_VALUE  "ERROR: x > 2^12-1"
#define MSG_X1_GREATER_THAN_X2        "ERROR: x1 > x2"
#define MSG_X2_GREATER_THAN_MAX_VALUE "ERROR: x2 > 2^12-1"

#define MSG_Y_LESS_THAN_ZERO          "ERROR: y < 0"
#define MSG_Y_GREATER_THAN_MAX_VALUE  "ERROR: y > 2^12-1"
#define MSG_Y1_GREATER_THAN_Y2        "ERROR: y1 > y2"
#define MSG_Y2_GREATER_THAN_MAX_VALUE "ERROR: y2 > 2^12-1"
