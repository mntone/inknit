...
_inknit_draw_vline32_4bpp_le:
	...
	movs	r6, #7			// r6 = 0x07
	ands	r6, r2			// r6 = x & 0x07
	lsls	r6, r6, #2		// r6 = bitpos = (x & 0x07) << 2
	...
	lsls	r2, #2			// r2 = colidx_in_word = (x >> 3) << 2
	lsrs	r1, #1			// r1 = stride_in_byte = stride >> 1
	muls	r3, r1			// r3 = rowidx = (stride >> 1) * y1
