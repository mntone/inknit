...
const struct inknit_exports x4 = {
	...
	.draw_hline      = INKNIT_X4_NAME(draw_hline),
	.draw_vline      = INKNIT_X4_NAME(draw_vline),
	.draw_line       = INKNIT_X4_NAME(draw_line),
	.draw_rect       = INKNIT_X4_NAME(draw_rect),
	.draw_rect_coord = INKNIT_X4_NAME(draw_rect_coord),
