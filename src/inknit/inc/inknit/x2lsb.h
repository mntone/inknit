...
// -- MARK: macro
#define INKNIT_X2LSB_BASE       x2lsb
#define INKNIT_X2LSB_NAME(name) INKNIT_PUBLIC_FUNCNAME(INKNIT_X2LSB_BASE, name)
#define PUBN(name)              INKNIT_PUBLIC_FUNCNAME(INKNIT_X2LSB_BASE, name)
#define INTN(name)              INKNIT_INTERNAL_FUNCNAME(INKNIT_X2LSB_BASE, name)
