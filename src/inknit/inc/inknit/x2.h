...
// -- MARK: macro
#define INKNIT_X2_BASE       x2
#define INKNIT_X2_NAME(name) INKNIT_PUBLIC_FUNCNAME(INKNIT_X2_BASE, name)
#define PUBN(name)           INKNIT_PUBLIC_FUNCNAME(INKNIT_X2_BASE, name)
#define INTN(name)           INKNIT_INTERNAL_FUNCNAME(INKNIT_X2_BASE, name)
