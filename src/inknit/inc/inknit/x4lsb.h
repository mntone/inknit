...
// -- MARK: macro
#define INKNIT_X4LSB_BASE       x4lsb
#define INKNIT_X4LSB_NAME(name) INKNIT_PUBLIC_FUNCNAME(INKNIT_X4LSB_BASE, name)
#define PUBN(name)              INKNIT_PUBLIC_FUNCNAME(INKNIT_X4LSB_BASE, name)
#define INTN(name)              INKNIT_INTERNAL_FUNCNAME(INKNIT_X4LSB_BASE, name)
