...
// -- MARK: macro
#define INKNIT_X4_BASE       x4
#define INKNIT_X4_NAME(name) INKNIT_PUBLIC_FUNCNAME(INKNIT_X4_BASE, name)
#define PUBN(name)           INKNIT_PUBLIC_FUNCNAME(INKNIT_X4_BASE, name)
#define INTN(name)           INKNIT_INTERNAL_FUNCNAME(INKNIT_X4_BASE, name)
