...
_inknit_draw_vline32_2bpp_le:
	...
	movs	r6, #15			// r6 = 0x0F
	ands	r6, r2			// r6 = x & 0x0F
	lsls	r6, r6, #1		// r6 = bitpos = (x & 0x0F) << 1

	movs	r4, #3			// r4 = 0b11
	lsls	r4, r6			// r4 = mask = 0b11 << bitpos
	...
	lsrs	r2, #4			// r2 = colidx_in_byte = x >> 4
	lsls	r2, #2			// r2 = colidx_in_word = (x >> 4) << 2
	lsrs	r1, #2			// r1 = stride_in_byte = stride >> 2
	muls	r3, r1			// r3 = rowidx = (stride >> 2) * y1
