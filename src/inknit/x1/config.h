...
#define TARGET_LAYOUT           INKNIT_X1
#define PUBLIC_FUNCNAME(name)   INKNIT_PUBLIC_FUNCNAME(INKNIT_X1_BASE, name)
#define INTERNAL_FUNCNAME(name) INKNIT_INTERNAL_FUNCNAME(INKNIT_X1_BASE, name)
#define INTERNAL_VARNAME(name)  INKNIT_INTERNAL_VARNAME(INKNIT_X1_BASE, name)
